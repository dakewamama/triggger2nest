...
var WalletController = function () {
    var _classDecorators = [(0, common_1.Controller)('api/wallet')];
    ...
    var WalletController = _classThis = /** @class */ (function () {
        ...
        WalletController_1.prototype.getBalance = function (address) {
            return __awaiter(this, void 0, void 0, function () {
                var balance;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.walletService.getBalance(address)];
                        case 1:
                            balance = _a.sent();
    ...
    (function () {
        ...
        _getBalance_decorators = [(0, common_1.Get)(':address/balance')];
