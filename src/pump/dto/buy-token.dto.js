...
var BuyTokenDto = function () {
    ...
    var _solAmount_decorators;
    var _solAmount_initializers = [];
    var _solAmount_extraInitializers = [];
    ...
    return _a = /** @class */ (function () {
            function BuyTokenDto() {
                ...
                this.amount = (__runInitializers(this, _publicKey_extraInitializers), __runInitializers(this, _amount_initializers, void 0)); // Number of tokens to buy
                this.solAmount = (__runInitializers(this, _amount_extraInitializers), __runInitializers(this, _solAmount_initializers, void 0)); // Amount of SOL to spend
                this.slippage = (__runInitializers(this, _solAmount_extraInitializers), __runInitializers(this, _slippage_initializers, void 0)); // Slippage tolerance (default 1%)
        ...
        (function () {
            ...
            _solAmount_decorators = [(0, class_validator_1.IsNumber)(), (0, class_validator_1.IsPositive)()];
            ...
            __esDecorate(null, null, _solAmount_decorators, { kind: "field", name: "solAmount", static: false, private: false, access: { has: function (obj) { return "solAmount" in obj; }, get: function (obj) { return obj.solAmount; }, set: function (obj, value) { obj.solAmount = value; } }, metadata: _metadata }, _solAmount_initializers, _solAmount_extraInitializers);
